...
// since weatherInfo already had main nested,
// it had the information that we wanted with the wind speed
// same with pressure
...
let descripitonsString = descriptions.join(', ')
console.log('The weather is ' + descripitonsString)